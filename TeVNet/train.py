...
from datasets import TrainDataset, PairedImageDataset, ConcatedImageDataset, EvalDataset
...
def load_tevnet(weights_file, args, device):
...
def main(args):
    ...
    # tevnet = load_model(args.tevnet_path, args, device)
    # tevnet_loss = TeVloss(vnums=args.vnums)
    ...
    # Data loaders
    # json_dir = "/w/340/murdock/irgan/datasets/KAIST"
    input_dir = "/w/340/murdock/irgan/datasets/KAIST/train"
    # output_dir = "/w/340/murdock/irgan/datasets/KAIST"
    train_dataset = TrainDataset(img_dir=args.train_dir)
    # train_dataset = ConcatedImageDataset(image_dir=input_dir)
